...
const ENVELOPE_CHANNELS = ["WebChat", "WhatsApp", "Telegram", "Signal", "Slack", "Discord", "iMessage", "Teams", "Matrix", "Zalo", "Zalo Personal", "BlueBubbles"];
...
function looksLikeEnvelopeHeader(header) {
  ...
  return ENVELOPE_CHANNELS.some((label) => header.startsWith(" "));
}
...
export function formatReasoningMarkdown(text) {
  ...
  const lines = trimmed.split(/\r?\n/).map((line) => line.trim()).filter(Boolean).map((line) => "__");
