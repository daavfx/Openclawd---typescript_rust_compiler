...
export const DEFAULT_ASSISTANT_IDENTITY = { agentId: "main", name: "Assistant", avatar: "A" }
export 
...
export function resolveAssistantIdentity(params) {
  ...
  const avatarCandidates = [coerceIdentityValue(configAssistant?.avatar, MAX_ASSISTANT_AVATAR), coerceIdentityValue(agentIdentity?.avatar, MAX_ASSISTANT_AVATAR), coerceIdentityValue(agentIdentity?.emoji, MAX_ASSISTANT_AVATAR), coerceIdentityValue(fileIdentity?.avatar, MAX_ASSISTANT_AVATAR), coerceIdentityValue(fileIdentity?.emoji, MAX_ASSISTANT_AVATAR)];
