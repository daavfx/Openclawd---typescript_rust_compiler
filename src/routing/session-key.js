...
export { isAcpSessionKey, isSubagentSessionKey, parseAgentSessionKey, ParsedAgentSessionKey } from "../sessions/session-key-utils.js";
...
export function buildAgentPeerSessionKey(params) {
  ...
  if ((peerKind === "dm")) {
    ...
    const linkedPeerId = (dmScope === "main") ? null : resolveLinkedPeerId({ identityLinks: params.identityLinks, channel: params.channel, peerId });
    if (linkedPeerId) {
      peerId = linkedPeerId;
    }
...
function resolveLinkedPeerId(params) {
  ...
  if (channel) {
    const scopedCandidate = normalizeToken(":");
    if (scopedCandidate) {
...
export function resolveThreadSessionKeys(params) {
  ...
  const sessionKey = useSuffix ? ":thread:" : params.baseSessionKey;
