...
That's it!";
    ...
    it("preserves think tags inside inline code", () => {
      const input = "The `<think>` tag is used for reasoning. Don't forget the closing `</think>` tag.";
      expect(stripReasoningTagsFromText(input)).toBe(input);
    });
...
``` then `<thought>`";
  ...
  describe("edge cases", () => {
    ...
    it("strips lone closing tag outside code", () => {
      ...
      expect(stripReasoningTagsFromText(input)).toBe("You can start with <think and then close with");
    });
...
~~~
    ...
    it("handles very long content between tags efficiently", () => {
      ...
      const input = "<think></think>visible";
  ...
  describe("strict vs preserve mode", () => {
    ...
    it("preserve mode keeps content after unclosed tag", () => {
      const input = "Before <think>unclosed content after";
      expect(stripReasoningTagsFromText(input, { mode: "preserve" })).toBe("Before unclosed content after");
    });
  });
