...
const CODEX_MODELS = ["gpt-5.2", "gpt-5.2-codex", "gpt-5.1-codex", "gpt-5.1-codex-mini", "gpt-5.1-codex-max"];
...
export function isModernModelRef(ref) {
  ...
  if (((provider === "openrouter") || (provider === "opencode"))) {
    return matchesAny(id, [...ANTHROPIC_PREFIXES, ...OPENAI_MODELS, ...CODEX_MODELS, ...GOOGLE_PREFIXES, ...ZAI_PREFIXES, ...MINIMAX_PREFIXES, ...XAI_PREFIXES]);
  }
  return false;
}
