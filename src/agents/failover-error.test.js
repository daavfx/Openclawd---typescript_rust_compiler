...
import { coerceToFailoverError, describeFailoverError, resolveFailoverReasonFromError } from "./failover-error.js";
describe("failover-error", () => {
  ...
  it("infers format errors from error messages", () => {
    expect(resolveFailoverReasonFromError({ message: "invalid request format: messages.1.content.1.tool_use.id" })).toBe("format");
  });
