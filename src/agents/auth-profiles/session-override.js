...
export async function resolveSessionAuthProfileOverride(params) {
  ...
  const source = (sessionEntry.authProfileOverrideSource ?? (typeof sessionEntry.authProfileOverrideCompactionCount === "number") ? "auto" : current ? "user" : undefined);
  ...
  if (isNewSession) {
    ...
    if ((current && (compactionCount > storedCompaction))) {
      ...
      if ((!current || isProfileInCooldown(store, current))) {
