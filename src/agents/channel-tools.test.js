...
describe("channel tools", () => {
  ...
  beforeEach(() => {
    const plugin = { id: "test", meta: { id: "test", label: "Test", selectionLabel: "Test", docsPath: "/channels/test", blurb: "test plugin" }, capabilities: { chatTypes: ["direct"] }, config: { listAccountIds: () => [], resolveAccount: () => {  } }, actions: { listActions: () => {
