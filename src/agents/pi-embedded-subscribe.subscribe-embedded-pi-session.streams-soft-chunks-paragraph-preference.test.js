...
describe("subscribeEmbeddedPiSession", () => {
  ...
  it("streams soft chunks with paragraph preference", () => {
    ...
    const subscription = subscribeEmbeddedPiSession({ session: session, runId: "run", onBlockReply, blockReplyBreak: "message_end", blockReplyChunking: { minChars: 5, maxChars: 25, breakPreference: "paragraph" } });
