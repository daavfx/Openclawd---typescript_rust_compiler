...
export 
export 
export const DEFAULT_CONTEXT_PRUNING_SETTINGS = { mode: "cache-ttl", ttlMs: ((5 * 60) * 1000), keepLastAssistants: 3, softTrimRatio: 0.3, hardClearRatio: 0.5, minPrunableToolChars: 50000, tools: {  }, softTrim: { maxChars: 4000, headChars: 1500, tailChars: 1500 }, hardClear: { enabled: true, placeholder: "[Old tool result content cleared]" } }
