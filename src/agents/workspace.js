...
async function loadTemplate(name) {
  ...
  try {
    ...
    {
      throw new Error("Missing workspace template:  (). Ensure docs/reference/templates are packaged.");
    }
  }
}
export 
...
export async function ensureAgentWorkspace(params) {
  ...
  return { dir, agentsPath, soulPath, toolsPath, identityPath, userPath, heartbeatPath, bootstrapPath };
}
