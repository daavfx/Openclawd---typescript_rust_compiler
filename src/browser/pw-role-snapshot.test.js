...
import { buildRoleSnapshotFromAiSnapshot, buildRoleSnapshotFromAriaSnapshot, getRoleSnapshotStats, parseRoleRef } from "./pw-role-snapshot.js";
describe("pw-role-snapshot", () => {
  it("adds refs for interactive elements", () => {
    const aria = ["- heading \"Example\" [level=1]", "- paragraph: hello", "- button \"Submit\"", "  - generic", "- link \"Learn more\""].join("
");
...
");
  ...
  it("preserves Playwright aria-ref ids in ai snapshots", () => {
    const ai = ["- navigation [ref=e1]:", "  - link \"Home\" [ref=e5]", "  - heading \"Title\" [ref=e6]", "  - button \"Save\" [ref=e7] [cursor=pointer]:", "  - paragraph: hello"].join("
");
