...
describe("browser target id resolution", () => {
  ...
  it("resolves unique prefixes (case-insensitive)", () => {
    ...
    expect(res).toEqual({ ok: true, targetId: "57A01309E14B5DEE0FB41F908515A2FC" });
  });
  it("fails on ambiguous prefixes", () => {
    const res = resolveTargetIdFromTabs("57A0", [{ targetId: "57A01309E14B5DEE0FB41F908515A2FC" }, { targetId: "57A0BEEF000000000000000000000000" }]);
