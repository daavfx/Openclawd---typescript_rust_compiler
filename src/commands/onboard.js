...
"));
  ...
  if ((normalizedOpts.nonInteractive && (normalizedOpts.acceptRisk !== true))) {
    runtime.error(["Non-interactive onboarding requires explicit risk acknowledgement.", "Read: https://docs.openclaw.ai/security", "Re-run with: "].join("
"));
    runtime.exit(1);
    return;
  }
  ...
  if ((process.platform === "win32")) {
    runtime.log(["Windows detected.", "WSL2 is strongly recommended; native Windows is untested and more problematic.", "Guide: https://docs.openclaw.ai/windows"].join("
"));
  }
