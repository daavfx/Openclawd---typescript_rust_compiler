...
export function applyGoogleGeminiModelDefault(cfg) {
  ...
  return { next: { ...cfg: , agents: { ...cfg.agents: , defaults: { ...cfg.agents?.defaults: , model: (cfg.agents?.defaults?.model && (typeof cfg.agents.defaults.model === "object")) ? { ...cfg.agents.defaults.model: , primary: GOOGLE_GEMINI_DEFAULT_MODEL } : { primary: GOOGLE_GEMINI_DEFAULT_MODEL } } } }, changed: true };
}
