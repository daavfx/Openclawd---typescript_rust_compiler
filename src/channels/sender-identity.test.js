...
describe("validateSenderIdentity", () => {
  ...
  it("validates SenderE164 and SenderUsername shape", () => {
    const ctx = { ChatType: "group", SenderE164: "123", SenderUsername: "@ada lovelace" };
    expect(validateSenderIdentity(ctx)).toEqual(["invalid SenderE164: 123", "SenderUsername should not include \"@\": @ada lovelace", "SenderUsername should not include whitespace: @ada lovelace"]);
  });
});
