...
export function resolveSessionTranscriptPath(sessionId, agentId, topicId) {
  const safeTopicId = (typeof topicId === "string") ? encodeURIComponent(topicId) : (typeof topicId === "number") ? String(topicId) : undefined;
  const fileName = (safeTopicId !== undefined) ? "-topic-.jsonl" : ".jsonl";
