export const defaultWaitingPhrases = ["flibbertigibbeting", "kerfuffling", "dillydallying", "twiddling thumbs", "noodling", "bamboozling", "moseying", "hobnobbing", "pondering", "conjuring"]
...
export function buildWaitingStatusMessage(params) {
  ...
  const cute = shimmerText(params.theme, "…", params.tick);
  return " •  | ";
}
