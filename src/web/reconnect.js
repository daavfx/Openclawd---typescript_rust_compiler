...
export const DEFAULT_RECONNECT_POLICY = { initialMs: 2000, maxMs: 30000, factor: 1.8, jitter: 0.25, maxAttempts: 12 }
...
export function resolveReconnectPolicy(cfg, overrides) {
  ...
  const merged = { ...DEFAULT_RECONNECT_POLICY: , ...reconnectOverrides: , ...overrideConfig:  };
