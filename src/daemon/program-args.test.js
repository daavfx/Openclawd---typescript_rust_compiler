...
const fsMocks = vi.hoisted(() => { access: vi.fn(), realpath: vi.fn() });
vi.mock("node:fs/promises", () => { default: { access: fsMocks.access, realpath: fsMocks.realpath }, access: fsMocks.access, realpath: fsMocks.realpath });
...
describe("resolveGatewayProgramArguments", () => {
  ...
  it("prefers symlinked path over realpath for stable service config", async () => {
    const symlinkPath = path.resolve("/Users/test/Library/pnpm/global/5/node_modules/openclaw/dist/entry.js");
