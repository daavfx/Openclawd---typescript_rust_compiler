...
export async function runExec(command, args, opts = 10000) {
  const options = (typeof opts === "number") ? { timeout: opts, encoding: "utf8" } : { timeout: opts.timeoutMs, maxBuffer: opts.maxBuffer, encoding: "utf8" };
  try {
    {
    ...
    {
      if (shouldLogVerbose()) {
        logError(danger("Command failed:  "));
      }
      throw err;
    }
  }
