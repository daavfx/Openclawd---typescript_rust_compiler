...
describe("markdownToSignalText", () => {
  it("renders inline styles", () => {
    ...
    expect(res.styles).toEqual([{ start: 3, length: 5, style: "ITALIC" }, { start: 9, length: 4, style: "BOLD" }, { start: 14, length: 4, style: "STRIKETHROUGH" }, { start: 19, length: 4, style: "MONOSPACE" }]);
  });
