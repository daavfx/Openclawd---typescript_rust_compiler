...
import { enableConsoleCapture, resetLogger, routeLogsToStderr, setConsoleTimestampPrefix, setLoggerOverride } from "../logging.js";
import { loggingState } from "./state.js";
let snapshot;
beforeEach(() => {
  snapshot = { log: console.log, info: console.info, warn: console.warn, error: console.error, debug: console.debug, trace: console.trace };
...
function tempLogPath() {
  return path.join(os.tmpdir(), "openclaw-log-.log");
}
function eioError() {
