...
vi.mock("@line/bot-sdk", () => { messagingApi: { MessagingApiClient: MessagingApiClientMock } });
let probeLineBot;
afterEach(() => {
  vi.useRealTimers();
...
describe("probeLineBot", () => {
  ...
  it("returns bot info when available", async () => {
    getBotInfoMock.mockResolvedValue({ displayName: "OpenClaw", userId: "U123", basicId: "@openclaw", pictureUrl: "https://example.com/bot.png" });
