...
export function buildCodeSpanIndex(text, inlineState) {
  ...
  return { inlineState: nextInlineState, isInside: (index) => (isInsideFenceSpan(index, fenceSpans) || isInsideInlineSpan(index, inlineSpans)) };
}
