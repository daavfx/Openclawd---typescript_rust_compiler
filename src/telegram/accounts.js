...
export function resolveTelegramAccount(params) {
  ...
  const resolve = (accountId) => {
    ...
    debugAccounts("resolve", { accountId, enabled, tokenSource: tokenResolution.source });
    return { accountId, enabled, name: (merged.name?.trim() || undefined), token: tokenResolution.token, tokenSource: tokenResolution.source, config: merged };
  };
