...
const matchLevelDirective = (body, names) => {
  ...
  const match = body.match(new RegExp("(?:^|\\s)\\/(?:)(?=$|\\s|:)", "i"));
...
const extractSimpleDirective = (body, names) => {
  const namePattern = names.map(escapeRegExp).join("|");
  const match = body.match(new RegExp("(?:^|\\s)\\/(?:)(?=$|\\s|:)(?:\\s*:\\s*)?", "i"));
...
export function extractThinkDirective(body) {
  ...
  return { cleaned: extracted.cleaned, thinkLevel: extracted.level, rawLevel: extracted.rawLevel, hasDirective: extracted.hasDirective };
}
...
export function extractVerboseDirective(body) {
  ...
  return { cleaned: extracted.cleaned, verboseLevel: extracted.level, rawLevel: extracted.rawLevel, hasDirective: extracted.hasDirective };
}
...
export function extractNoticeDirective(body) {
  ...
  return { cleaned: extracted.cleaned, noticeLevel: extracted.level, rawLevel: extracted.rawLevel, hasDirective: extracted.hasDirective };
}
...
export function extractElevatedDirective(body) {
  ...
  return { cleaned: extracted.cleaned, elevatedLevel: extracted.level, rawLevel: extracted.rawLevel, hasDirective: extracted.hasDirective };
}
...
export function extractReasoningDirective(body) {
  ...
  return { cleaned: extracted.cleaned, reasoningLevel: extracted.level, rawLevel: extracted.rawLevel, hasDirective: extracted.hasDirective };
}
