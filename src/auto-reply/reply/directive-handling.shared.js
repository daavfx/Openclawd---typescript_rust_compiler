...
export const formatOptionsLine = (options) => "Options: ."
export const withOptions = (line, options) => "
"
export const formatElevatedRuntimeHint = () => " Runtime is direct; sandboxing does not apply."
