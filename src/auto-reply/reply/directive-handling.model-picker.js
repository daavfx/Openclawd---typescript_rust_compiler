...
export 
export 
const MODEL_PICK_PROVIDER_PREFERENCE = ["anthropic", "openai", "openai-codex", "minimax", "synthetic", "google", "zai", "openrouter", "opencode", "github-copilot", "groq", "cerebras", "mistral", "xai", "lmstudio"];
...
export function resolveProviderEndpointLabel(provider, cfg) {
  ...
  return { endpoint: (endpoint || undefined), api: (api || undefined) };
}
