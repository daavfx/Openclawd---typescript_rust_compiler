...
export async function resolveMessageChannelSelection(params) {
  ...
  if (normalized) {
    ...
    return { channel: normalized, configured: await listConfiguredMessageChannels(params.cfg) };
  }
  ...
  throw new Error("Channel is required when multiple channels are configured: ");
}
