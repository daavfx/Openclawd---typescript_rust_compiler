...
import { consumeRestartSentinel, readRestartSentinel, resolveRestartSentinelPath, trimLogTail, writeRestartSentinel } from "./restart-sentinel.js";
describe("restart sentinel", () => {
  ...
  it("writes and consumes a sentinel", async () => {
    const payload = { kind: "update", status: "ok", ts: Date.now(), sessionKey: "agent:main:whatsapp:dm:+15555550123", stats: { mode: "git" } };
