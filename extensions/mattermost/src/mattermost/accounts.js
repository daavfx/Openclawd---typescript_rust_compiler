...
export function resolveMattermostAccount(params) {
  ...
  return { accountId, enabled, name: (merged.name?.trim() || undefined), botToken, baseUrl, botTokenSource, baseUrlSource, config: merged, chatmode: merged.chatmode, oncharPrefixes: merged.oncharPrefixes, requireMention, textChunkLimit: merged.textChunkLimit, blockStreaming: merged.blockStreaming, blockStreamingCoalesce: merged.blockStreamingCoalesce };
}
