...
describe("zalo directory", () => {
  it("lists peers from allowFrom", async () => {
    const cfg = { channels: { zalo: { allowFrom: ["zalo:123", "zl:234", "345"] } } };
    ...
    await expect(zaloPlugin.directory.listPeers({ cfg, accountId: undefined, query: undefined, limit: undefined })).resolves.toEqual(expect.arrayContaining([{ kind: "user", id: "123" }, { kind: "user", id: "234" }, { kind: "user", id: "345" }]));
