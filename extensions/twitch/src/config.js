...
export function getAccountConfig(coreConfig, accountId) {
  ...
  if ((accountId === DEFAULT_ACCOUNT_ID)) {
    ...
    const baseLevel = { username: (typeof twitchRaw?.username === "string") ? twitchRaw.username : undefined, accessToken: (typeof twitchRaw?.accessToken === "string") ? twitchRaw.accessToken : undefined, clientId: (typeof twitchRaw?.clientId === "string") ? twitchRaw.clientId : undefined, channel: (typeof twitchRaw?.channel === "string") ? twitchRaw.channel : undefined, enabled: (typeof twitchRaw?.enabled === "boolean") ? twitchRaw.enabled : undefined, allowFrom: Array.isArray(twitchRaw?.allowFrom) ? twitchRaw.allowFrom : undefined, allowedRoles: Array.isArray(twitchRaw?.allowedRoles) ? twitchRaw.allowedRoles : undefined, requireMention: (typeof twitchRaw?.requireMention === "boolean") ? twitchRaw.requireMention : undefined, clientSecret: (typeof twitchRaw?.clientSecret === "string") ? twitchRaw.clientSecret : undefined, refreshToken: (typeof twitchRaw?.refreshToken === "string") ? twitchRaw.refreshToken : undefined, expiresIn: (typeof twitchRaw?.expiresIn === "number") ? twitchRaw.expiresIn : undefined, obtainmentTimestamp: (typeof twitchRaw?.obtainmentTimestamp === "number") ? twitchRaw.obtainmentTimestamp : undefined };
    const merged = { ...accountFromAccounts: , ...baseLevel:  };
    if (merged.username) {
      return merged;
    }
