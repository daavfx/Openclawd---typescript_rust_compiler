...
const TwitchAccountSchema = z.object({ username: z.string(), accessToken: z.string(), clientId: z.string().optional(), channel: z.string().min(1), enabled: z.boolean().optional(), allowFrom: z.array(z.string()).optional(), allowedRoles: z.array(TwitchRoleSchema).optional(), requireMention: z.boolean().optional(), clientSecret: z.string().optional(), refreshToken: z.string().optional(), expiresIn: z.number().nullable().optional(), obtainmentTimestamp: z.number().optional() });
const TwitchConfigBaseSchema = z.object({ name: z.string().optional(), enabled: z.boolean().optional(), markdown: MarkdownConfigSchema.optional() });
