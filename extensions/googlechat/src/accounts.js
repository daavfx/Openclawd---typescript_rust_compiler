...
export function resolveGoogleChatAccount(params) {
  ...
  return { accountId, name: (merged.name?.trim() || undefined), enabled, config: merged, credentialSource: credentials.source, credentials: credentials.credentials, credentialsFile: credentials.credentialsFile };
}
