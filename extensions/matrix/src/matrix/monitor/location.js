import { formatLocationText, toLocationContext } from "openclaw/plugin-sdk";
...
export function resolveMatrixLocation(params) {
  ...
  const location = { latitude: parsed.latitude, longitude: parsed.longitude, accuracy: parsed.accuracy, caption: (caption || undefined), source: "pin", isLive: false };
  return { text: formatLocationText(location), context: toLocationContext(location) };
}
