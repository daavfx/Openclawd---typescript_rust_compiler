  ...
  try {
    {
      ...
      return { userId, profile: { displayName: (profile?.displayname ?? null), avatarUrl: (profile?.avatar_url ?? null) }, membership: null, powerLevel: null, displayName: (profile?.displayname ?? null), roomId: (roomId ?? null) };
    }
  }
  finally {
    {
  ...
  try {
    {
      ...
      return { roomId: resolvedRoom, name, topic, canonicalAlias, altAliases: [], memberCount };
    }
  }
  finally {
    {
