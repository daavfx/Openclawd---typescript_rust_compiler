  ...
  try {
    {
      ...
      const res = await client.doRequest("GET", "/_matrix/client/v1/rooms//relations///", { dir: "b", limit });
...
export async function removeMatrixReactions(roomId, messageId, opts = {  }) {
  ...
  try {
    {
      const resolvedRoom = await resolveMatrixRoomId(client, roomId);
      const res = await client.doRequest("GET", "/_matrix/client/v1/rooms//relations///", { dir: "b", limit: 200 });
