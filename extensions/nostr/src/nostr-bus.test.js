...
import { validatePrivateKey, getPublicKeyFromPrivate, isValidPubkey, normalizePubkey, pubkeyToNpub } from "./nostr-bus.js";
...
describe("isValidPubkey", () => {
  ...
  describe("edge cases", () => {
    ...
    it("handles whitespace-padded input", () => {
      const validHex = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef";
      expect(isValidPubkey("    ")).toBe(true);
    });
  });
});
describe("normalizePubkey", () => {
  describe("hex format", () => {
    ...
    it("trims whitespace", () => {
      ...
      expect(normalizePubkey("    ")).toBe(hex);
    });
